...
Trump_ECV_0 = ctwh_change.query("result == 'Donald Trump' and timeframe == '0'")['ECV'].sum()
Biden_ECV_0 = ctwh_change.query("result == 'Joe Biden' and timeframe == '0'")['ECV'].sum()
...
print('0 days Out: Joe Biden: ',Biden_ECV_0,' Donald Trump: ',Trump_ECV_0 )
