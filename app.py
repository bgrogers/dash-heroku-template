...
Original file is located at
    https://colab.research.google.com/drive/1fLGsYH6NMbuN97Y6_crZnuvv4zydd5YL
"""
...
ctwh_results['result'] = pd.cut(ctwh_results.Biden_Win_Probability, [-.5, 0.5, 1.5], labels=['Donald Trump','Joe Biden'])
ctwh_results['State Rating'] = pd.cut(ctwh_results.Biden_Win_Probability, [-.5,.20,.35, .5 ,.65,.80,1.5], labels=['Safe R', 'Likely R','Slightly R','Slightly D','Likely D','Safe D'])
